...
state_t	states[NUMSTATES] = {
  ...
  {SPR_ACLO,4,1050,{(actionf_p1)A_FreeTargMobj},S_NULL,0,0},	/* S_FREETARGMOBJ */
...
{SPR_ACLO,4,1400,{NULL},S_HIDESPECIAL2,0,0},	/* S_HIDESPECIAL1 */
  {SPR_ACLO,0,4,{(actionf_p1)A_RestoreSpecialThing1},S_HIDESPECIAL3,0,0},	/* S_HIDESPECIAL2 */
...
{SPR_ACLO,3,4,{(actionf_p1)A_RestoreSpecialThing2},S_NULL,0,0},	/* S_HIDESPECIAL11 */
...
{SPR_ACLO,0,1400,{(actionf_p1)A_HideThing},S_DORMANTARTI12,0,0},	/* S_DORMANTARTI11 */
{SPR_ACLO,0,3,{(actionf_p1)A_UnHideThing},S_DORMANTARTI13,0,0},	/* S_DORMANTARTI12 */
...
{SPR_ACLO,3,3,{(actionf_p1)A_RestoreArtifact},S_NULL,0,0},	/* S_DORMANTARTI21 */
...
{SPR_FBMB,4,6,{(actionf_p1)A_Scream},S_FIREBOMB6,0,0},	/* S_FIREBOMB5 */
{SPR_XPL1,32768,4,{(actionf_p1)A_Explode},S_FIREBOMB7,0,0},	/* S_FIREBOMB6 */
...
{SPR_PPOD,1,14,{(actionf_p1)A_PodPain},S_POD_WAIT1,0,0},	/* S_POD_PAIN1 */
{SPR_PPOD,32770,5,{(actionf_p1)A_RemovePod},S_POD_DIE2,0,0},	/* S_POD_DIE1 */
{SPR_PPOD,32771,5,{(actionf_p1)A_Scream},S_POD_DIE3,0,0},	/* S_POD_DIE2 */
{SPR_PPOD,32772,5,{(actionf_p1)A_Explode},S_POD_DIE4,0,0},	/* S_POD_DIE3 */
...
{SPR_AMG1,0,35,{(actionf_p1)A_MakePod},S_PODGENERATOR,0,0},	/* S_PODGENERATOR */
...
{SPR_KGZ1,0,1, {(actionf_p1)A_InitKeyGizmo},S_KEYGIZMO3,0,0},	/* S_KEYGIZMO2 */
...
{SPR_VLCO,0,35,{(actionf_p1)A_VolcanoSet},S_VOLCANO3,0,0},	/* S_VOLCANO2 */
...
{SPR_VLCO,4,10,{(actionf_p1)A_VolcanoBlast},S_VOLCANO2,0,0},	/* S_VOLCANO9 */
{SPR_VFBL,0,4,{(actionf_p1)A_BeastPuff},S_VOLCANOBALL2,0,0},	/* S_VOLCANOBALL1 */
{SPR_VFBL,1,4,{(actionf_p1)A_BeastPuff},S_VOLCANOBALL1,0,0},	/* S_VOLCANOBALL2 */
{SPR_XPL1,0,4,{(actionf_p1)A_VolcBallImpact},S_VOLCANOBALLX2,0,0},	/* S_VOLCANOBALLX1 */
...
{SPR_TGLT,0,8,{(actionf_p1)A_SpawnTeleGlitter},S_TELEGLITGEN1,0,0},	/* S_TELEGLITGEN1 */
{SPR_TGLT,5,8,{(actionf_p1)A_SpawnTeleGlitter2},S_TELEGLITGEN2,0,0},	/* S_TELEGLITGEN2 */
{SPR_TGLT,32768,2,{NULL},S_TELEGLITTER1_2,0,0},	/* S_TELEGLITTER1_1 */
{SPR_TGLT,32769,2,{(actionf_p1)A_AccTeleGlitter},S_TELEGLITTER1_3,0,0},	/* S_TELEGLITTER1_2 */
{SPR_TGLT,32770,2,{NULL},S_TELEGLITTER1_4,0,0},	/* S_TELEGLITTER1_3 */
{SPR_TGLT,32771,2,{(actionf_p1)A_AccTeleGlitter},S_TELEGLITTER1_5,0,0},	/* S_TELEGLITTER1_4 */
{SPR_TGLT,32772,2,{NULL},S_TELEGLITTER1_1,0,0},	/* S_TELEGLITTER1_5 */
{SPR_TGLT,32773,2,{NULL},S_TELEGLITTER2_2,0,0},	/* S_TELEGLITTER2_1 */
{SPR_TGLT,32774,2,{(actionf_p1)A_AccTeleGlitter},S_TELEGLITTER2_3,0,0},	/* S_TELEGLITTER2_2 */
{SPR_TGLT,32775,2,{NULL},S_TELEGLITTER2_4,0,0},	/* S_TELEGLITTER2_3 */
{SPR_TGLT,32776,2,{(actionf_p1)A_AccTeleGlitter},S_TELEGLITTER2_5,0,0},	/* S_TELEGLITTER2_4 */
...
{SPR_STFF,0,0,{(actionf_p1)A_Light0},S_NULL,0,0},	/* S_LIGHTDONE */
{SPR_STFF,0,1,{(actionf_p1)A_WeaponReady},S_STAFFREADY,0,0},	/* S_STAFFREADY */
{SPR_STFF,0,1,{(actionf_p1)A_Lower},S_STAFFDOWN,0,0},	/* S_STAFFDOWN */
{SPR_STFF,0,1,{(actionf_p1)A_Raise},S_STAFFUP,0,0},	/* S_STAFFUP */
{SPR_STFF,3,4,{(actionf_p1)A_WeaponReady},S_STAFFREADY2_2,0,0},	/* S_STAFFREADY2_1 */
{SPR_STFF,4,4,{(actionf_p1)A_WeaponReady},S_STAFFREADY2_3,0,0},	/* S_STAFFREADY2_2 */
{SPR_STFF,5,4,{(actionf_p1)A_WeaponReady},S_STAFFREADY2_1,0,0},	/* S_STAFFREADY2_3 */
{SPR_STFF,3,1,{(actionf_p1)A_Lower},S_STAFFDOWN2,0,0},	/* S_STAFFDOWN2 */
{SPR_STFF,3,1,{(actionf_p1)A_Raise},S_STAFFUP2,0,0},	/* S_STAFFUP2 */
{SPR_STFF,1,6,{NULL},S_STAFFATK1_2,0,0},	/* S_STAFFATK1_1 */
{SPR_STFF,2,8,{(actionf_p1)A_StaffAttackPL1},S_STAFFATK1_3,0,0},	/* S_STAFFATK1_2 */
{SPR_STFF,1,8,{(actionf_p1)A_ReFire},S_STAFFREADY,0,0},	/* S_STAFFATK1_3 */
{SPR_STFF,6,6,{NULL},S_STAFFATK2_2,0,0},	/* S_STAFFATK2_1 */
{SPR_STFF,7,8,{(actionf_p1)A_StaffAttackPL2},S_STAFFATK2_3,0,0},	/* S_STAFFATK2_2 */
{SPR_STFF,6,8,{(actionf_p1)A_ReFire},S_STAFFREADY2_1,0,0},	/* S_STAFFATK2_3 */
...
{SPR_BEAK,0,1,{(actionf_p1)A_BeakReady},S_BEAKREADY,0,0},	/* S_BEAKREADY */
{SPR_BEAK,0,1,{(actionf_p1)A_Lower},S_BEAKDOWN,0,0},	/* S_BEAKDOWN */
{SPR_BEAK,0,1,{(actionf_p1)A_BeakRaise},S_BEAKUP,0,0},	/* S_BEAKUP */
{SPR_BEAK,0,18,{(actionf_p1)A_BeakAttackPL1},S_BEAKREADY,0,0},	/* S_BEAKATK1_1 */
{SPR_BEAK,0,12,{(actionf_p1)A_BeakAttackPL2},S_BEAKREADY,0,0},	/* S_BEAKATK2_1 */
{SPR_WGNT,0,-1,{NULL},S_NULL,0,0},	/* S_WGNT */
{SPR_GAUN,0,1,{(actionf_p1)A_WeaponReady},S_GAUNTLETREADY,0,0},	/* S_GAUNTLETREADY */
{SPR_GAUN,0,1,{(actionf_p1)A_Lower},S_GAUNTLETDOWN,0,0},	/* S_GAUNTLETDOWN */
{SPR_GAUN,0,1,{(actionf_p1)A_Raise},S_GAUNTLETUP,0,0},	/* S_GAUNTLETUP */
{SPR_GAUN,6,4,{(actionf_p1)A_WeaponReady},S_GAUNTLETREADY2_2,0,0},	/* S_GAUNTLETREADY2_1 */
{SPR_GAUN,7,4,{(actionf_p1)A_WeaponReady},S_GAUNTLETREADY2_3,0,0},	/* S_GAUNTLETREADY2_2 */
{SPR_GAUN,8,4,{(actionf_p1)A_WeaponReady},S_GAUNTLETREADY2_1,0,0},	/* S_GAUNTLETREADY2_3 */
{SPR_GAUN,6,1,{(actionf_p1)A_Lower},S_GAUNTLETDOWN2,0,0},	/* S_GAUNTLETDOWN2 */
{SPR_GAUN,6,1,{(actionf_p1)A_Raise},S_GAUNTLETUP2,0,0},	/* S_GAUNTLETUP2 */
{SPR_GAUN,1,4,{NULL},S_GAUNTLETATK1_2,0,0},	/* S_GAUNTLETATK1_1 */
{SPR_GAUN,2,4,{NULL},S_GAUNTLETATK1_3,0,0},	/* S_GAUNTLETATK1_2 */
{SPR_GAUN,32771,4,{(actionf_p1)A_GauntletAttack},S_GAUNTLETATK1_4,0,0},	/* S_GAUNTLETATK1_3 */
{SPR_GAUN,32772,4,{(actionf_p1)A_GauntletAttack},S_GAUNTLETATK1_5,0,0},	/* S_GAUNTLETATK1_4 */
{SPR_GAUN,32773,4,{(actionf_p1)A_GauntletAttack},S_GAUNTLETATK1_6,0,0},	/* S_GAUNTLETATK1_5 */
{SPR_GAUN,2,4,{(actionf_p1)A_ReFire},S_GAUNTLETATK1_7,0,0},	/* S_GAUNTLETATK1_6 */
{SPR_GAUN,1,4,{(actionf_p1)A_Light0},S_GAUNTLETREADY,0,0},	/* S_GAUNTLETATK1_7 */
{SPR_GAUN,9,4,{NULL},S_GAUNTLETATK2_2,0,0},	/* S_GAUNTLETATK2_1 */
{SPR_GAUN,10,4,{NULL},S_GAUNTLETATK2_3,0,0},	/* S_GAUNTLETATK2_2 */
{SPR_GAUN,32779,4,{(actionf_p1)A_GauntletAttack},S_GAUNTLETATK2_4,0,0},	/* S_GAUNTLETATK2_3 */
{SPR_GAUN,32780,4,{(actionf_p1)A_GauntletAttack},S_GAUNTLETATK2_5,0,0},	/* S_GAUNTLETATK2_4 */
{SPR_GAUN,32781,4,{(actionf_p1)A_GauntletAttack},S_GAUNTLETATK2_6,0,0},	/* S_GAUNTLETATK2_5 */
{SPR_GAUN,10,4,{(actionf_p1)A_ReFire},S_GAUNTLETATK2_7,0,0},	/* S_GAUNTLETATK2_6 */
{SPR_GAUN,9,4,{(actionf_p1)A_Light0},S_GAUNTLETREADY2_1,0,0},	/* S_GAUNTLETATK2_7 */
...
{SPR_BLSR,0,1,{(actionf_p1)A_WeaponReady},S_BLASTERREADY,0,0},	/* S_BLASTERREADY */
{SPR_BLSR,0,1,{(actionf_p1)A_Lower},S_BLASTERDOWN,0,0},	/* S_BLASTERDOWN */
{SPR_BLSR,0,1,{(actionf_p1)A_Raise},S_BLASTERUP,0,0},	/* S_BLASTERUP */
{SPR_BLSR,1,3,{NULL},S_BLASTERATK1_2,0,0},	/* S_BLASTERATK1_1 */
{SPR_BLSR,2,3,{NULL},S_BLASTERATK1_3,0,0},	/* S_BLASTERATK1_2 */
{SPR_BLSR,3,2,{(actionf_p1)A_FireBlasterPL1},S_BLASTERATK1_4,0,0},	/* S_BLASTERATK1_3 */
{SPR_BLSR,2,2,{NULL},S_BLASTERATK1_5,0,0},	/* S_BLASTERATK1_4 */
{SPR_BLSR,1,2,{NULL},S_BLASTERATK1_6,0,0},	/* S_BLASTERATK1_5 */
{SPR_BLSR,0,0,{(actionf_p1)A_ReFire},S_BLASTERREADY,0,0},	/* S_BLASTERATK1_6 */
{SPR_BLSR,1,0,{NULL},S_BLASTERATK2_2,0,0},	/* S_BLASTERATK2_1 */
{SPR_BLSR,2,0,{NULL},S_BLASTERATK2_3,0,0},	/* S_BLASTERATK2_2 */
{SPR_BLSR,3,3,{(actionf_p1)A_FireBlasterPL2},S_BLASTERATK2_4,0,0},	/* S_BLASTERATK2_3 */
{SPR_BLSR,2,4,{NULL},S_BLASTERATK2_5,0,0},	/* S_BLASTERATK2_4 */
{SPR_BLSR,1,4,{NULL},S_BLASTERATK2_6,0,0},	/* S_BLASTERATK2_5 */
{SPR_BLSR,0,0,{(actionf_p1)A_ReFire},S_BLASTERREADY,0,0},	/* S_BLASTERATK2_6 */
{SPR_ACLO,4,200,{NULL},S_BLASTERFX1_1,0,0},	/* S_BLASTERFX1_1 */
{SPR_FX18,32768,3,{(actionf_p1)A_SpawnRippers},S_BLASTERFXI1_2,0,0},	/* S_BLASTERFXI1_1 */
...
{SPR_MACE,0,1,{(actionf_p1)A_WeaponReady},S_MACEREADY,0,0},	/* S_MACEREADY */
{SPR_MACE,0,1,{(actionf_p1)A_Lower},S_MACEDOWN,0,0},	/* S_MACEDOWN */
{SPR_MACE,0,1,{(actionf_p1)A_Raise},S_MACEUP,0,0},	/* S_MACEUP */
{SPR_MACE,1,4,{NULL},S_MACEATK1_2,0,0},	/* S_MACEATK1_1 */
{SPR_MACE,2,3,{(actionf_p1)A_FireMacePL1},S_MACEATK1_3,0,0},	/* S_MACEATK1_2 */
{SPR_MACE,3,3,{(actionf_p1)A_FireMacePL1},S_MACEATK1_4,0,0},	/* S_MACEATK1_3 */
{SPR_MACE,4,3,{(actionf_p1)A_FireMacePL1},S_MACEATK1_5,0,0},	/* S_MACEATK1_4 */
{SPR_MACE,5,3,{(actionf_p1)A_FireMacePL1},S_MACEATK1_6,0,0},	/* S_MACEATK1_5 */
{SPR_MACE,2,4,{(actionf_p1)A_ReFire},S_MACEATK1_7,0,0},	/* S_MACEATK1_6 */
...
{SPR_MACE,3,4,{(actionf_p1)A_FireMacePL2},S_MACEATK2_3,0,0},	/* S_MACEATK2_2 */
{SPR_MACE,1,4,{NULL},S_MACEATK2_4,0,0},	/* S_MACEATK2_3 */
{SPR_MACE,0,8,{(actionf_p1)A_ReFire},S_MACEREADY,0,0},	/* S_MACEATK2_4 */
{SPR_FX02,0,4,{(actionf_p1)A_MacePL1Check},S_MACEFX1_2,0,0},	/* S_MACEFX1_1 */
{SPR_FX02,1,4,{(actionf_p1)A_MacePL1Check},S_MACEFX1_1,0,0},	/* S_MACEFX1_2 */
{SPR_FX02,32773,4,{(actionf_p1)A_MaceBallImpact},S_MACEFXI1_2,0,0},	/* S_MACEFXI1_1 */
...
{SPR_FX02,32773,4,{(actionf_p1)A_MaceBallImpact2},S_MACEFXI1_2,0,0},	/* S_MACEFXI2_1 */
...
{SPR_FX02,32770,4,{(actionf_p1)A_DeathBallImpact},S_MACEFXI1_2,0,0},	/* S_MACEFXI4_1 */
{SPR_WSKL,0,-1,{NULL},S_NULL,0,0},	/* S_WSKL */
{SPR_HROD,0,1,{(actionf_p1)A_WeaponReady},S_HORNRODREADY,0,0},	/* S_HORNRODREADY */
{SPR_HROD,0,1,{(actionf_p1)A_Lower},S_HORNRODDOWN,0,0},	/* S_HORNRODDOWN */
{SPR_HROD,0,1,{(actionf_p1)A_Raise},S_HORNRODUP,0,0},	/* S_HORNRODUP */
{SPR_HROD,0,4,{(actionf_p1)A_FireSkullRodPL1},S_HORNRODATK1_2,0,0},	/* S_HORNRODATK1_1 */
{SPR_HROD,1,4,{(actionf_p1)A_FireSkullRodPL1},S_HORNRODATK1_3,0,0},	/* S_HORNRODATK1_2 */
{SPR_HROD,1,0,{(actionf_p1)A_ReFire},S_HORNRODREADY,0,0},	/* S_HORNRODATK1_3 */
...
{SPR_HROD,6,4,{(actionf_p1)A_FireSkullRodPL2},S_HORNRODATK2_6,0,0},	/* S_HORNRODATK2_5 */
...
{SPR_HROD,2,2,{(actionf_p1)A_ReFire},S_HORNRODREADY,0,0},	/* S_HORNRODATK2_9 */
...
{SPR_FX00,32771,3,{(actionf_p1)A_SkullRodPL2Seek},S_HRODFX2_3,0,0},	/* S_HRODFX2_2 */
{SPR_FX00,32772,3,{NULL},S_HRODFX2_4,0,0},	/* S_HRODFX2_3 */
{SPR_FX00,32773,3,{(actionf_p1)A_SkullRodPL2Seek},S_HRODFX2_1,0,0},	/* S_HRODFX2_4 */
{SPR_FX00,32775,5,{(actionf_p1)A_AddPlayerRain},S_HRODFXI2_2,0,0},	/* S_HRODFXI2_1 */
...
{SPR_FX00,6,1,{(actionf_p1)A_HideInCeiling},S_HRODFXI2_8,0,0},	/* S_HRODFXI2_7 */
{SPR_FX00,6,1,{(actionf_p1)A_SkullRodStorm},S_HRODFXI2_8,0,0},	/* S_HRODFXI2_8 */
...
{SPR_FX20,32769,4,{(actionf_p1)A_RainImpact},S_RAINPLR1X_2,0,0},	/* S_RAINPLR1X_1 */
...
{SPR_FX21,32769,4,{(actionf_p1)A_RainImpact},S_RAINPLR2X_2,0,0},	/* S_RAINPLR2X_1 */
...
{SPR_FX22,32769,4,{(actionf_p1)A_RainImpact},S_RAINPLR3X_2,0,0},	/* S_RAINPLR3X_1 */
...
{SPR_FX23,32769,4,{(actionf_p1)A_RainImpact},S_RAINPLR4X_2,0,0},	/* S_RAINPLR4X_1 */
...
{SPR_GWND,0,1,{(actionf_p1)A_WeaponReady},S_GOLDWANDREADY,0,0},	/* S_GOLDWANDREADY */
{SPR_GWND,0,1,{(actionf_p1)A_Lower},S_GOLDWANDDOWN,0,0},	/* S_GOLDWANDDOWN */
{SPR_GWND,0,1,{(actionf_p1)A_Raise},S_GOLDWANDUP,0,0},	/* S_GOLDWANDUP */
{SPR_GWND,1,3,{NULL},S_GOLDWANDATK1_2,0,0},	/* S_GOLDWANDATK1_1 */
{SPR_GWND,2,5,{(actionf_p1)A_FireGoldWandPL1},S_GOLDWANDATK1_3,0,0},	/* S_GOLDWANDATK1_2 */
{SPR_GWND,3,3,{NULL},S_GOLDWANDATK1_4,0,0},	/* S_GOLDWANDATK1_3 */
{SPR_GWND,3,0,{(actionf_p1)A_ReFire},S_GOLDWANDREADY,0,0},	/* S_GOLDWANDATK1_4 */
{SPR_GWND,1,3,{NULL},S_GOLDWANDATK2_2,0,0},	/* S_GOLDWANDATK2_1 */
{SPR_GWND,2,4,{(actionf_p1)A_FireGoldWandPL2},S_GOLDWANDATK2_3,0,0},	/* S_GOLDWANDATK2_2 */
{SPR_GWND,3,3,{NULL},S_GOLDWANDATK2_4,0,0},	/* S_GOLDWANDATK2_3 */
{SPR_GWND,3,0,{(actionf_p1)A_ReFire},S_GOLDWANDREADY,0,0},	/* S_GOLDWANDATK2_4 */
...
{SPR_PHNX,0,1,{(actionf_p1)A_WeaponReady},S_PHOENIXREADY,0,0},	/* S_PHOENIXREADY */
{SPR_PHNX,0,1,{(actionf_p1)A_Lower},S_PHOENIXDOWN,0,0},	/* S_PHOENIXDOWN */
{SPR_PHNX,0,1,{(actionf_p1)A_Raise},S_PHOENIXUP,0,0},	/* S_PHOENIXUP */
{SPR_PHNX,1,5,{NULL},S_PHOENIXATK1_2,0,0},	/* S_PHOENIXATK1_1 */
{SPR_PHNX,2,7,{(actionf_p1)A_FirePhoenixPL1},S_PHOENIXATK1_3,0,0},	/* S_PHOENIXATK1_2 */
{SPR_PHNX,3,4,{NULL},S_PHOENIXATK1_4,0,0},	/* S_PHOENIXATK1_3 */
{SPR_PHNX,1,4,{NULL},S_PHOENIXATK1_5,0,0},	/* S_PHOENIXATK1_4 */
{SPR_PHNX,1,0,{(actionf_p1)A_ReFire},S_PHOENIXREADY,0,0},	/* S_PHOENIXATK1_5 */
{SPR_PHNX,1,3,{(actionf_p1)A_InitPhoenixPL2},S_PHOENIXATK2_2,0,0},	/* S_PHOENIXATK2_1 */
{SPR_PHNX,32770,1,{(actionf_p1)A_FirePhoenixPL2},S_PHOENIXATK2_3,0,0},	/* S_PHOENIXATK2_2 */
{SPR_PHNX,1,4,{(actionf_p1)A_ReFire},S_PHOENIXATK2_4,0,0},	/* S_PHOENIXATK2_3 */
{SPR_PHNX,1,4,{(actionf_p1)A_ShutdownPhoenixPL2},S_PHOENIXREADY,0,0},	/* S_PHOENIXATK2_4 */
{SPR_FX04,32768,4,{(actionf_p1)A_PhoenixPuff},S_PHOENIXFX1_1,0,0},	/* S_PHOENIXFX1_1 */
{SPR_FX08,32768,6,{(actionf_p1)A_Explode},S_PHOENIXFXI1_2,0,0},	/* S_PHOENIXFXI1_1 */
...
{SPR_FX09,32769,2,{(actionf_p1)A_FlameEnd},S_PHOENIXFX2_7,0,0},	/* S_PHOENIXFX2_6 */
...
{SPR_FX09,32775,3,{(actionf_p1)A_FloatPuff},S_PHOENIXFXI2_3,0,0},	/* S_PHOENIXFXI2_2 */
...
{SPR_CRBW,0,1,{(actionf_p1)A_WeaponReady},S_CRBOW2,0,0},	/* S_CRBOW1 */
{SPR_CRBW,0,1,{(actionf_p1)A_WeaponReady},S_CRBOW3,0,0},	/* S_CRBOW2 */
{SPR_CRBW,0,1,{(actionf_p1)A_WeaponReady},S_CRBOW4,0,0},	/* S_CRBOW3 */
{SPR_CRBW,0,1,{(actionf_p1)A_WeaponReady},S_CRBOW5,0,0},	/* S_CRBOW4 */
{SPR_CRBW,0,1,{(actionf_p1)A_WeaponReady},S_CRBOW6,0,0},	/* S_CRBOW5 */
{SPR_CRBW,0,1,{(actionf_p1)A_WeaponReady},S_CRBOW7,0,0},	/* S_CRBOW6 */
{SPR_CRBW,1,1,{(actionf_p1)A_WeaponReady},S_CRBOW8,0,0},	/* S_CRBOW7 */
{SPR_CRBW,1,1,{(actionf_p1)A_WeaponReady},S_CRBOW9,0,0},	/* S_CRBOW8 */
{SPR_CRBW,1,1,{(actionf_p1)A_WeaponReady},S_CRBOW10,0,0},	/* S_CRBOW9 */
{SPR_CRBW,1,1,{(actionf_p1)A_WeaponReady},S_CRBOW11,0,0},	/* S_CRBOW10 */
{SPR_CRBW,1,1,{(actionf_p1)A_WeaponReady},S_CRBOW12,0,0},	/* S_CRBOW11 */
{SPR_CRBW,1,1,{(actionf_p1)A_WeaponReady},S_CRBOW13,0,0},	/* S_CRBOW12 */
{SPR_CRBW,2,1,{(actionf_p1)A_WeaponReady},S_CRBOW14,0,0},	/* S_CRBOW13 */
{SPR_CRBW,2,1,{(actionf_p1)A_WeaponReady},S_CRBOW15,0,0},	/* S_CRBOW14 */
{SPR_CRBW,2,1,{(actionf_p1)A_WeaponReady},S_CRBOW16,0,0},	/* S_CRBOW15 */
{SPR_CRBW,2,1,{(actionf_p1)A_WeaponReady},S_CRBOW17,0,0},	/* S_CRBOW16 */
{SPR_CRBW,2,1,{(actionf_p1)A_WeaponReady},S_CRBOW18,0,0},	/* S_CRBOW17 */
{SPR_CRBW,2,1,{(actionf_p1)A_WeaponReady},S_CRBOW1,0,0},	/* S_CRBOW18 */
{SPR_CRBW,0,1,{(actionf_p1)A_Lower},S_CRBOWDOWN,0,0},	/* S_CRBOWDOWN */
{SPR_CRBW,0,1,{(actionf_p1)A_Raise},S_CRBOWUP,0,0},	/* S_CRBOWUP */
{SPR_CRBW,3,6,{(actionf_p1)A_FireCrossbowPL1},S_CRBOWATK1_2,0,0},	/* S_CRBOWATK1_1 */
...
{SPR_CRBW,2,5,{(actionf_p1)A_ReFire},S_CRBOW1,0,0},	/* S_CRBOWATK1_8 */
{SPR_CRBW,3,5,{(actionf_p1)A_FireCrossbowPL2},S_CRBOWATK2_2,0,0},	/* S_CRBOWATK2_1 */
...
{SPR_CRBW,2,4,{(actionf_p1)A_ReFire},S_CRBOW1,0,0},	/* S_CRBOWATK2_8 */
...
{SPR_FX03,32769,1,{(actionf_p1)A_BoltSpark},S_CRBOWFX2,0,0},	/* S_CRBOWFX2 */
...
{SPR_PLAY,8,6,{(actionf_p1)A_Scream},S_PLAY_DIE3,0,0},	/* S_PLAY_DIE2 */
{SPR_PLAY,9,6,{NULL},S_PLAY_DIE4,0,0},	/* S_PLAY_DIE3 */
{SPR_PLAY,10,6,{NULL},S_PLAY_DIE5,0,0},	/* S_PLAY_DIE4 */
{SPR_PLAY,11,6,{(actionf_p1)A_NoBlocking},S_PLAY_DIE6,0,0},	/* S_PLAY_DIE5 */
...
{SPR_PLAY,15,-1,{(actionf_p1)A_AddPlayerCorpse},S_NULL,0,0},	/* S_PLAY_DIE9 */
{SPR_PLAY,16,5,{(actionf_p1)A_Scream},S_PLAY_XDIE2,0,0},	/* S_PLAY_XDIE1 */
{SPR_PLAY,17,5,{(actionf_p1)A_SkullPop},S_PLAY_XDIE3,0,0},	/* S_PLAY_XDIE2 */
{SPR_PLAY,18,5,{(actionf_p1)A_NoBlocking},S_PLAY_XDIE4,0,0},	/* S_PLAY_XDIE3 */
...
{SPR_PLAY,24,-1,{(actionf_p1)A_AddPlayerCorpse},S_NULL,0,0},	/* S_PLAY_XDIE9 */
{SPR_FDTH,32768,5,{(actionf_p1)A_FlameSnd},S_PLAY_FDTH2,0,0},	/* S_PLAY_FDTH1 */
{SPR_FDTH,32769,4,{NULL},S_PLAY_FDTH3,0,0},	/* S_PLAY_FDTH2 */
{SPR_FDTH,32770,5,{NULL},S_PLAY_FDTH4,0,0},	/* S_PLAY_FDTH3 */
{SPR_FDTH,32771,4,{(actionf_p1)A_Scream},S_PLAY_FDTH5,0,0},	/* S_PLAY_FDTH4 */
{SPR_FDTH,32772,5,{NULL},S_PLAY_FDTH6,0,0},	/* S_PLAY_FDTH5 */
{SPR_FDTH,32773,4,{NULL},S_PLAY_FDTH7,0,0},	/* S_PLAY_FDTH6 */
{SPR_FDTH,32774,5,{(actionf_p1)A_FlameSnd},S_PLAY_FDTH8,0,0},	/* S_PLAY_FDTH7 */
...
{SPR_FDTH,32782,5,{(actionf_p1)A_NoBlocking},S_PLAY_FDTH16,0,0},	/* S_PLAY_FDTH15 */
...
{SPR_ACLO,4,35,{(actionf_p1)A_CheckBurnGone},S_PLAY_FDTH19,0,0},	/* S_PLAY_FDTH19 */
{SPR_ACLO,4,8,{NULL},S_NULL,0,0},	/* S_PLAY_FDTH20 */
{SPR_BSKL,0,5,{(actionf_p1)A_CheckSkullFloor},S_BLOODYSKULL2,0,0},	/* S_BLOODYSKULL1 */
{SPR_BSKL,1,5,{(actionf_p1)A_CheckSkullFloor},S_BLOODYSKULL3,0,0},	/* S_BLOODYSKULL2 */
{SPR_BSKL,2,5,{(actionf_p1)A_CheckSkullFloor},S_BLOODYSKULL4,0,0},	/* S_BLOODYSKULL3 */
{SPR_BSKL,3,5,{(actionf_p1)A_CheckSkullFloor},S_BLOODYSKULL5,0,0},	/* S_BLOODYSKULL4 */
{SPR_BSKL,4,5,{(actionf_p1)A_CheckSkullFloor},S_BLOODYSKULL1,0,0},	/* S_BLOODYSKULL5 */
{SPR_BSKL,5,16,{(actionf_p1)A_CheckSkullDone},S_BLOODYSKULLX1,0,0},	/* S_BLOODYSKULLX1 */
...
{SPR_CHKN,3,4,{(actionf_p1)A_Feathers},S_CHICPLAY_PAIN2,0,0},	/* S_CHICPLAY_PAIN */
{SPR_CHKN,2,4,{(actionf_p1)A_Pain},S_CHICPLAY,0,0},	/* S_CHICPLAY_PAIN2 */
{SPR_CHKN,0,10,{(actionf_p1)A_ChicLook},S_CHICKEN_LOOK2,0,0},	/* S_CHICKEN_LOOK1 */
{SPR_CHKN,1,10,{(actionf_p1)A_ChicLook},S_CHICKEN_LOOK1,0,0},	/* S_CHICKEN_LOOK2 */
{SPR_CHKN,0,3,{(actionf_p1)A_ChicChase},S_CHICKEN_WALK2,0,0},	/* S_CHICKEN_WALK1 */
{SPR_CHKN,1,3,{(actionf_p1)A_ChicChase},S_CHICKEN_WALK1,0,0},	/* S_CHICKEN_WALK2 */
{SPR_CHKN,3,5,{(actionf_p1)A_Feathers},S_CHICKEN_PAIN2,0,0},	/* S_CHICKEN_PAIN1 */
{SPR_CHKN,2,5,{(actionf_p1)A_ChicPain},S_CHICKEN_WALK1,0,0},	/* S_CHICKEN_PAIN2 */
{SPR_CHKN,0,8,{(actionf_p1)A_FaceTarget},S_CHICKEN_ATK2,0,0},	/* S_CHICKEN_ATK1 */
{SPR_CHKN,2,10,{(actionf_p1)A_ChicAttack},S_CHICKEN_WALK1,0,0},	/* S_CHICKEN_ATK2 */
{SPR_CHKN,4,6,{(actionf_p1)A_Scream},S_CHICKEN_DIE2,0,0},	/* S_CHICKEN_DIE1 */
{SPR_CHKN,5,6,{(actionf_p1)A_Feathers},S_CHICKEN_DIE3,0,0},	/* S_CHICKEN_DIE2 */
{SPR_CHKN,6,6,{NULL},S_CHICKEN_DIE4,0,0},	/* S_CHICKEN_DIE3 */
{SPR_CHKN,7,6,{(actionf_p1)A_NoBlocking},S_CHICKEN_DIE5,0,0},	/* S_CHICKEN_DIE4 */
...
{SPR_MUMM,0,10,{(actionf_p1)A_Look},S_MUMMY_LOOK2,0,0},	/* S_MUMMY_LOOK1 */
{SPR_MUMM,1,10,{(actionf_p1)A_Look},S_MUMMY_LOOK1,0,0},	/* S_MUMMY_LOOK2 */
{SPR_MUMM,0,4,{(actionf_p1)A_Chase},S_MUMMY_WALK2,0,0},	/* S_MUMMY_WALK1 */
{SPR_MUMM,1,4,{(actionf_p1)A_Chase},S_MUMMY_WALK3,0,0},	/* S_MUMMY_WALK2 */
{SPR_MUMM,2,4,{(actionf_p1)A_Chase},S_MUMMY_WALK4,0,0},	/* S_MUMMY_WALK3 */
{SPR_MUMM,3,4,{(actionf_p1)A_Chase},S_MUMMY_WALK1,0,0},	/* S_MUMMY_WALK4 */
{SPR_MUMM,4,6,{(actionf_p1)A_FaceTarget},S_MUMMY_ATK2,0,0},	/* S_MUMMY_ATK1 */
{SPR_MUMM,5,6,{(actionf_p1)A_MummyAttack},S_MUMMY_ATK3,0,0},	/* S_MUMMY_ATK2 */
{SPR_MUMM,6,6,{(actionf_p1)A_FaceTarget},S_MUMMY_WALK1,0,0},	/* S_MUMMY_ATK3 */
{SPR_MUMM,23,5,{(actionf_p1)A_FaceTarget},S_MUMMYL_ATK2,0,0},	/* S_MUMMYL_ATK1 */
{SPR_MUMM,32792,5,{(actionf_p1)A_FaceTarget},S_MUMMYL_ATK3,0,0},	/* S_MUMMYL_ATK2 */
{SPR_MUMM,23,5,{(actionf_p1)A_FaceTarget},S_MUMMYL_ATK4,0,0},	/* S_MUMMYL_ATK3 */
{SPR_MUMM,32792,5,{(actionf_p1)A_FaceTarget},S_MUMMYL_ATK5,0,0},	/* S_MUMMYL_ATK4 */
{SPR_MUMM,23,5,{(actionf_p1)A_FaceTarget},S_MUMMYL_ATK6,0,0},	/* S_MUMMYL_ATK5 */
{SPR_MUMM,32792,15,{(actionf_p1)A_MummyAttack2},S_MUMMY_WALK1,0,0},	/* S_MUMMYL_ATK6 */
{SPR_MUMM,7,4,{NULL},S_MUMMY_PAIN2,0,0},	/* S_MUMMY_PAIN1 */
{SPR_MUMM,7,4,{(actionf_p1)A_Pain},S_MUMMY_WALK1,0,0},	/* S_MUMMY_PAIN2 */
{SPR_MUMM,8,5,{NULL},S_MUMMY_DIE2,0,0},	/* S_MUMMY_DIE1 */
{SPR_MUMM,9,5,{(actionf_p1)A_Scream},S_MUMMY_DIE3,0,0},	/* S_MUMMY_DIE2 */
{SPR_MUMM,10,5,{(actionf_p1)A_MummySoul},S_MUMMY_DIE4,0,0},	/* S_MUMMY_DIE3 */
{SPR_MUMM,11,5,{NULL},S_MUMMY_DIE5,0,0},	/* S_MUMMY_DIE4 */
{SPR_MUMM,12,5,{(actionf_p1)A_NoBlocking},S_MUMMY_DIE6,0,0},	/* S_MUMMY_DIE5 */
...
{SPR_FX15,32768,5,{(actionf_p1)A_ContMobjSound},S_MUMMYFX1_2,0,0},	/* S_MUMMYFX1_1 */
{SPR_FX15,32769,5,{(actionf_p1)A_MummyFX1Seek},S_MUMMYFX1_3,0,0},	/* S_MUMMYFX1_2 */
{SPR_FX15,32770,5,{NULL},S_MUMMYFX1_4,0,0},	/* S_MUMMYFX1_3 */
{SPR_FX15,32769,5,{(actionf_p1)A_MummyFX1Seek},S_MUMMYFX1_1,0,0},	/* S_MUMMYFX1_4 */
...
{SPR_BEAS,0,10,{(actionf_p1)A_Look},S_BEAST_LOOK2,0,0},	/* S_BEAST_LOOK1 */
{SPR_BEAS,1,10,{(actionf_p1)A_Look},S_BEAST_LOOK1,0,0},	/* S_BEAST_LOOK2 */
{SPR_BEAS,0,3,{(actionf_p1)A_Chase},S_BEAST_WALK2,0,0},	/* S_BEAST_WALK1 */
{SPR_BEAS,1,3,{(actionf_p1)A_Chase},S_BEAST_WALK3,0,0},	/* S_BEAST_WALK2 */
{SPR_BEAS,2,3,{(actionf_p1)A_Chase},S_BEAST_WALK4,0,0},	/* S_BEAST_WALK3 */
{SPR_BEAS,3,3,{(actionf_p1)A_Chase},S_BEAST_WALK5,0,0},	/* S_BEAST_WALK4 */
{SPR_BEAS,4,3,{(actionf_p1)A_Chase},S_BEAST_WALK6,0,0},	/* S_BEAST_WALK5 */
{SPR_BEAS,5,3,{(actionf_p1)A_Chase},S_BEAST_WALK1,0,0},	/* S_BEAST_WALK6 */
{SPR_BEAS,7,10,{(actionf_p1)A_FaceTarget},S_BEAST_ATK2,0,0},	/* S_BEAST_ATK1 */
{SPR_BEAS,8,10,{(actionf_p1)A_BeastAttack},S_BEAST_WALK1,0,0},	/* S_BEAST_ATK2 */
{SPR_BEAS,6,3,{NULL},S_BEAST_PAIN2,0,0},	/* S_BEAST_PAIN1 */
{SPR_BEAS,6,3,{(actionf_p1)A_Pain},S_BEAST_WALK1,0,0},	/* S_BEAST_PAIN2 */
{SPR_BEAS,17,6,{NULL},S_BEAST_DIE2,0,0},	/* S_BEAST_DIE1 */
{SPR_BEAS,18,6,{(actionf_p1)A_Scream},S_BEAST_DIE3,0,0},	/* S_BEAST_DIE2 */
...
{SPR_BEAS,22,6,{(actionf_p1)A_NoBlocking},S_BEAST_DIE7,0,0},	/* S_BEAST_DIE6 */
...
{SPR_BEAS,10,6,{(actionf_p1)A_Scream},S_BEAST_XDIE3,0,0},	/* S_BEAST_XDIE2 */
...
{SPR_BEAS,14,6,{(actionf_p1)A_NoBlocking},S_BEAST_XDIE7,0,0},	/* S_BEAST_XDIE6 */
{SPR_BEAS,15,5,{NULL},S_BEAST_XDIE8,0,0},	/* S_BEAST_XDIE7 */
{SPR_BEAS,16,-1,{NULL},S_NULL,0,0},	/* S_BEAST_XDIE8 */
{SPR_FRB1,0,2,{(actionf_p1)A_BeastPuff},S_BEASTBALL2,0,0},	/* S_BEASTBALL1 */
{SPR_FRB1,0,2,{(actionf_p1)A_BeastPuff},S_BEASTBALL3,0,0},	/* S_BEASTBALL2 */
{SPR_FRB1,1,2,{(actionf_p1)A_BeastPuff},S_BEASTBALL4,0,0},	/* S_BEASTBALL3 */
{SPR_FRB1,1,2,{(actionf_p1)A_BeastPuff},S_BEASTBALL5,0,0},	/* S_BEASTBALL4 */
{SPR_FRB1,2,2,{(actionf_p1)A_BeastPuff},S_BEASTBALL6,0,0},	/* S_BEASTBALL5 */
{SPR_FRB1,2,2,{(actionf_p1)A_BeastPuff},S_BEASTBALL1,0,0},	/* S_BEASTBALL6 */
...
{SPR_SNKE,0,10,{(actionf_p1)A_Look},S_SNAKE_LOOK2,0,0},	/* S_SNAKE_LOOK1 */
{SPR_SNKE,1,10,{(actionf_p1)A_Look},S_SNAKE_LOOK1,0,0},	/* S_SNAKE_LOOK2 */
{SPR_SNKE,0,4,{(actionf_p1)A_Chase},S_SNAKE_WALK2,0,0},	/* S_SNAKE_WALK1 */
{SPR_SNKE,1,4,{(actionf_p1)A_Chase},S_SNAKE_WALK3,0,0},	/* S_SNAKE_WALK2 */
{SPR_SNKE,2,4,{(actionf_p1)A_Chase},S_SNAKE_WALK4,0,0},	/* S_SNAKE_WALK3 */
{SPR_SNKE,3,4,{(actionf_p1)A_Chase},S_SNAKE_WALK1,0,0},	/* S_SNAKE_WALK4 */
{SPR_SNKE,5,5,{(actionf_p1)A_FaceTarget},S_SNAKE_ATK2,0,0},	/* S_SNAKE_ATK1 */
{SPR_SNKE,5,5,{(actionf_p1)A_FaceTarget},S_SNAKE_ATK3,0,0},	/* S_SNAKE_ATK2 */
{SPR_SNKE,5,4,{(actionf_p1)A_SnakeAttack},S_SNAKE_ATK4,0,0},	/* S_SNAKE_ATK3 */
{SPR_SNKE,5,4,{(actionf_p1)A_SnakeAttack},S_SNAKE_ATK5,0,0},	/* S_SNAKE_ATK4 */
{SPR_SNKE,5,4,{(actionf_p1)A_SnakeAttack},S_SNAKE_ATK6,0,0},	/* S_SNAKE_ATK5 */
{SPR_SNKE,5,5,{(actionf_p1)A_FaceTarget},S_SNAKE_ATK7,0,0},	/* S_SNAKE_ATK6 */
{SPR_SNKE,5,5,{(actionf_p1)A_FaceTarget},S_SNAKE_ATK8,0,0},	/* S_SNAKE_ATK7 */
{SPR_SNKE,5,5,{(actionf_p1)A_FaceTarget},S_SNAKE_ATK9,0,0},	/* S_SNAKE_ATK8 */
{SPR_SNKE,5,4,{(actionf_p1)A_SnakeAttack2},S_SNAKE_WALK1,0,0},	/* S_SNAKE_ATK9 */
{SPR_SNKE,4,3,{NULL},S_SNAKE_PAIN2,0,0},	/* S_SNAKE_PAIN1 */
{SPR_SNKE,4,3,{(actionf_p1)A_Pain},S_SNAKE_WALK1,0,0},	/* S_SNAKE_PAIN2 */
{SPR_SNKE,6,5,{NULL},S_SNAKE_DIE2,0,0},	/* S_SNAKE_DIE1 */
{SPR_SNKE,7,5,{(actionf_p1)A_Scream},S_SNAKE_DIE3,0,0},	/* S_SNAKE_DIE2 */
...
{SPR_SNKE,12,5,{(actionf_p1)A_NoBlocking},S_SNAKE_DIE8,0,0},	/* S_SNAKE_DIE7 */
...
{SPR_HEAD,0,10,{(actionf_p1)A_Look},S_HEAD_LOOK,0,0},	/* S_HEAD_LOOK */
{SPR_HEAD,0,4,{(actionf_p1)A_Chase},S_HEAD_FLOAT,0,0},	/* S_HEAD_FLOAT */
{SPR_HEAD,0,5,{(actionf_p1)A_FaceTarget},S_HEAD_ATK2,0,0},	/* S_HEAD_ATK1 */
{SPR_HEAD,1,20,{(actionf_p1)A_HeadAttack},S_HEAD_FLOAT,0,0},	/* S_HEAD_ATK2 */
{SPR_HEAD,0,4,{NULL},S_HEAD_PAIN2,0,0},	/* S_HEAD_PAIN1 */
{SPR_HEAD,0,4,{(actionf_p1)A_Pain},S_HEAD_FLOAT,0,0},	/* S_HEAD_PAIN2 */
{SPR_HEAD,2,7,{NULL},S_HEAD_DIE2,0,0},	/* S_HEAD_DIE1 */
{SPR_HEAD,3,7,{(actionf_p1)A_Scream},S_HEAD_DIE3,0,0},	/* S_HEAD_DIE2 */
{SPR_HEAD,4,7,{NULL},S_HEAD_DIE4,0,0},	/* S_HEAD_DIE3 */
{SPR_HEAD,5,7,{NULL},S_HEAD_DIE5,0,0},	/* S_HEAD_DIE4 */
{SPR_HEAD,6,7,{(actionf_p1)A_NoBlocking},S_HEAD_DIE6,0,0},	/* S_HEAD_DIE5 */
{SPR_HEAD,7,7,{NULL},S_HEAD_DIE7,0,0},	/* S_HEAD_DIE6 */
{SPR_HEAD,8,-1,{(actionf_p1)A_BossDeath},S_NULL,0,0},	/* S_HEAD_DIE7 */
...
{SPR_FX05,3,5,{(actionf_p1)A_HeadIceImpact},S_HEADFXI1_2,0,0},	/* S_HEADFXI1_1 */
...
{SPR_FX06,0,4,{(actionf_p1)A_HeadFireGrow},S_HEADFX3_2,0,0},	/* S_HEADFX3_1 */
{SPR_FX06,1,4,{(actionf_p1)A_HeadFireGrow},S_HEADFX3_3,0,0},	/* S_HEADFX3_2 */
{SPR_FX06,2,4,{(actionf_p1)A_HeadFireGrow},S_HEADFX3_1,0,0},	/* S_HEADFX3_3 */
...
{SPR_FX07,0,3,{(actionf_p1)A_WhirlwindSeek},S_HEADFX4_6,0,0},	/* S_HEADFX4_5 */
{SPR_FX07,1,3,{(actionf_p1)A_WhirlwindSeek},S_HEADFX4_7,0,0},	/* S_HEADFX4_6 */
{SPR_FX07,2,3,{(actionf_p1)A_WhirlwindSeek},S_HEADFX4_5,0,0},	/* S_HEADFX4_7 */
...
{SPR_CLNK,0,10,{(actionf_p1)A_Look},S_CLINK_LOOK2,0,0},	/* S_CLINK_LOOK1 */
{SPR_CLNK,1,10,{(actionf_p1)A_Look},S_CLINK_LOOK1,0,0},	/* S_CLINK_LOOK2 */
{SPR_CLNK,0,3,{(actionf_p1)A_Chase},S_CLINK_WALK2,0,0},	/* S_CLINK_WALK1 */
{SPR_CLNK,1,3,{(actionf_p1)A_Chase},S_CLINK_WALK3,0,0},	/* S_CLINK_WALK2 */
{SPR_CLNK,2,3,{(actionf_p1)A_Chase},S_CLINK_WALK4,0,0},	/* S_CLINK_WALK3 */
{SPR_CLNK,3,3,{(actionf_p1)A_Chase},S_CLINK_WALK1,0,0},	/* S_CLINK_WALK4 */
{SPR_CLNK,4,5,{(actionf_p1)A_FaceTarget},S_CLINK_ATK2,0,0},	/* S_CLINK_ATK1 */
{SPR_CLNK,5,4,{(actionf_p1)A_FaceTarget},S_CLINK_ATK3,0,0},	/* S_CLINK_ATK2 */
{SPR_CLNK,6,7,{(actionf_p1)A_ClinkAttack},S_CLINK_WALK1,0,0},	/* S_CLINK_ATK3 */
{SPR_CLNK,7,3,{NULL},S_CLINK_PAIN2,0,0},	/* S_CLINK_PAIN1 */
{SPR_CLNK,7,3,{(actionf_p1)A_Pain},S_CLINK_WALK1,0,0},	/* S_CLINK_PAIN2 */
{SPR_CLNK,8,6,{NULL},S_CLINK_DIE2,0,0},	/* S_CLINK_DIE1 */
{SPR_CLNK,9,6,{NULL},S_CLINK_DIE3,0,0},	/* S_CLINK_DIE2 */
{SPR_CLNK,10,5,{(actionf_p1)A_Scream},S_CLINK_DIE4,0,0},	/* S_CLINK_DIE3 */
{SPR_CLNK,11,5,{(actionf_p1)A_NoBlocking},S_CLINK_DIE5,0,0},	/* S_CLINK_DIE4 */
...
{SPR_WZRD,0,10,{(actionf_p1)A_Look},S_WIZARD_LOOK2,0,0},	/* S_WIZARD_LOOK1 */
{SPR_WZRD,1,10,{(actionf_p1)A_Look},S_WIZARD_LOOK1,0,0},	/* S_WIZARD_LOOK2 */
{SPR_WZRD,0,3,{(actionf_p1)A_Chase},S_WIZARD_WALK2,0,0},	/* S_WIZARD_WALK1 */
{SPR_WZRD,0,4,{(actionf_p1)A_Chase},S_WIZARD_WALK3,0,0},	/* S_WIZARD_WALK2 */
{SPR_WZRD,0,3,{(actionf_p1)A_Chase},S_WIZARD_WALK4,0,0},	/* S_WIZARD_WALK3 */
{SPR_WZRD,0,4,{(actionf_p1)A_Chase},S_WIZARD_WALK5,0,0},	/* S_WIZARD_WALK4 */
{SPR_WZRD,1,3,{(actionf_p1)A_Chase},S_WIZARD_WALK6,0,0},	/* S_WIZARD_WALK5 */
{SPR_WZRD,1,4,{(actionf_p1)A_Chase},S_WIZARD_WALK7,0,0},	/* S_WIZARD_WALK6 */
{SPR_WZRD,1,3,{(actionf_p1)A_Chase},S_WIZARD_WALK8,0,0},	/* S_WIZARD_WALK7 */
{SPR_WZRD,1,4,{(actionf_p1)A_Chase},S_WIZARD_WALK1,0,0},	/* S_WIZARD_WALK8 */
{SPR_WZRD,2,4,{(actionf_p1)A_WizAtk1},S_WIZARD_ATK2,0,0},	/* S_WIZARD_ATK1 */
{SPR_WZRD,2,4,{(actionf_p1)A_WizAtk2},S_WIZARD_ATK3,0,0},	/* S_WIZARD_ATK2 */
{SPR_WZRD,2,4,{(actionf_p1)A_WizAtk1},S_WIZARD_ATK4,0,0},	/* S_WIZARD_ATK3 */
{SPR_WZRD,2,4,{(actionf_p1)A_WizAtk2},S_WIZARD_ATK5,0,0},	/* S_WIZARD_ATK4 */
{SPR_WZRD,2,4,{(actionf_p1)A_WizAtk1},S_WIZARD_ATK6,0,0},	/* S_WIZARD_ATK5 */
{SPR_WZRD,2,4,{(actionf_p1)A_WizAtk2},S_WIZARD_ATK7,0,0},	/* S_WIZARD_ATK6 */
{SPR_WZRD,2,4,{(actionf_p1)A_WizAtk1},S_WIZARD_ATK8,0,0},	/* S_WIZARD_ATK7 */
{SPR_WZRD,2,4,{(actionf_p1)A_WizAtk2},S_WIZARD_ATK9,0,0},	/* S_WIZARD_ATK8 */
{SPR_WZRD,3,12,{(actionf_p1)A_WizAtk3},S_WIZARD_WALK1,0,0},	/* S_WIZARD_ATK9 */
{SPR_WZRD,4,3,{(actionf_p1)A_GhostOff},S_WIZARD_PAIN2,0,0},	/* S_WIZARD_PAIN1 */
{SPR_WZRD,4,3,{(actionf_p1)A_Pain},S_WIZARD_WALK1,0,0},	/* S_WIZARD_PAIN2 */
{SPR_WZRD,5,6,{(actionf_p1)A_GhostOff},S_WIZARD_DIE2,0,0},	/* S_WIZARD_DIE1 */
{SPR_WZRD,6,6,{(actionf_p1)A_Scream},S_WIZARD_DIE3,0,0},	/* S_WIZARD_DIE2 */
{SPR_WZRD,7,6,{NULL},S_WIZARD_DIE4,0,0},	/* S_WIZARD_DIE3 */
{SPR_WZRD,8,6,{NULL},S_WIZARD_DIE5,0,0},	/* S_WIZARD_DIE4 */
{SPR_WZRD,9,6,{(actionf_p1)A_NoBlocking},S_WIZARD_DIE6,0,0},	/* S_WIZARD_DIE5 */
...
{SPR_IMPX,0,10,{(actionf_p1)A_Look},S_IMP_LOOK2,0,0},	/* S_IMP_LOOK1 */
{SPR_IMPX,1,10,{(actionf_p1)A_Look},S_IMP_LOOK3,0,0},	/* S_IMP_LOOK2 */
{SPR_IMPX,2,10,{(actionf_p1)A_Look},S_IMP_LOOK4,0,0},	/* S_IMP_LOOK3 */
{SPR_IMPX,1,10,{(actionf_p1)A_Look},S_IMP_LOOK1,0,0},	/* S_IMP_LOOK4 */
{SPR_IMPX,0,3,{(actionf_p1)A_Chase},S_IMP_FLY2,0,0},	/* S_IMP_FLY1 */
{SPR_IMPX,0,3,{(actionf_p1)A_Chase},S_IMP_FLY3,0,0},	/* S_IMP_FLY2 */
{SPR_IMPX,1,3,{(actionf_p1)A_Chase},S_IMP_FLY4,0,0},	/* S_IMP_FLY3 */
{SPR_IMPX,1,3,{(actionf_p1)A_Chase},S_IMP_FLY5,0,0},	/* S_IMP_FLY4 */
{SPR_IMPX,2,3,{(actionf_p1)A_Chase},S_IMP_FLY6,0,0},	/* S_IMP_FLY5 */
{SPR_IMPX,2,3,{(actionf_p1)A_Chase},S_IMP_FLY7,0,0},	/* S_IMP_FLY6 */
{SPR_IMPX,1,3,{(actionf_p1)A_Chase},S_IMP_FLY8,0,0},	/* S_IMP_FLY7 */
{SPR_IMPX,1,3,{(actionf_p1)A_Chase},S_IMP_FLY1,0,0},	/* S_IMP_FLY8 */
{SPR_IMPX,3,6,{(actionf_p1)A_FaceTarget},S_IMP_MEATK2,0,0},	/* S_IMP_MEATK1 */
{SPR_IMPX,4,6,{(actionf_p1)A_FaceTarget},S_IMP_MEATK3,0,0},	/* S_IMP_MEATK2 */
{SPR_IMPX,5,6,{(actionf_p1)A_ImpMeAttack},S_IMP_FLY1,0,0},	/* S_IMP_MEATK3 */
{SPR_IMPX,0,10,{(actionf_p1)A_FaceTarget},S_IMP_MSATK1_2,0,0},	/* S_IMP_MSATK1_1 */
{SPR_IMPX,1,6,{(actionf_p1)A_ImpMsAttack},S_IMP_MSATK1_3,0,0},	/* S_IMP_MSATK1_2 */
...
{SPR_IMPX,3,6,{(actionf_p1)A_FaceTarget},S_IMP_MSATK2_2,0,0},	/* S_IMP_MSATK2_1 */
{SPR_IMPX,4,6,{(actionf_p1)A_FaceTarget},S_IMP_MSATK2_3,0,0},	/* S_IMP_MSATK2_2 */
{SPR_IMPX,5,6,{(actionf_p1)A_ImpMsAttack2},S_IMP_FLY1,0,0},	/* S_IMP_MSATK2_3 */
{SPR_IMPX,6,3,{NULL},S_IMP_PAIN2,0,0},	/* S_IMP_PAIN1 */
{SPR_IMPX,6,3,{(actionf_p1)A_Pain},S_IMP_FLY1,0,0},	/* S_IMP_PAIN2 */
{SPR_IMPX,6,4,{(actionf_p1)A_ImpDeath},S_IMP_DIE2,0,0},	/* S_IMP_DIE1 */
{SPR_IMPX,7,5,{NULL},S_IMP_DIE2,0,0},	/* S_IMP_DIE2 */
{SPR_IMPX,18,5,{(actionf_p1)A_ImpXDeath1},S_IMP_XDIE2,0,0},	/* S_IMP_XDIE1 */
{SPR_IMPX,19,5,{NULL},S_IMP_XDIE3,0,0},	/* S_IMP_XDIE2 */
{SPR_IMPX,20,5,{NULL},S_IMP_XDIE4,0,0},	/* S_IMP_XDIE3 */
{SPR_IMPX,21,5,{(actionf_p1)A_ImpXDeath2},S_IMP_XDIE5,0,0},	/* S_IMP_XDIE4 */
{SPR_IMPX,22,5,{NULL},S_IMP_XDIE5,0,0},	/* S_IMP_XDIE5 */
{SPR_IMPX,8,7,{(actionf_p1)A_ImpExplode},S_IMP_CRASH2,0,0},	/* S_IMP_CRASH1 */
{SPR_IMPX,9,7,{(actionf_p1)A_Scream},S_IMP_CRASH3,0,0},	/* S_IMP_CRASH2 */
...
{SPR_KNIG,0,10,{(actionf_p1)A_Look},S_KNIGHT_STND2,0,0},	/* S_KNIGHT_STND1 */
{SPR_KNIG,1,10,{(actionf_p1)A_Look},S_KNIGHT_STND1,0,0},	/* S_KNIGHT_STND2 */
{SPR_KNIG,0,4,{(actionf_p1)A_Chase},S_KNIGHT_WALK2,0,0},	/* S_KNIGHT_WALK1 */
{SPR_KNIG,1,4,{(actionf_p1)A_Chase},S_KNIGHT_WALK3,0,0},	/* S_KNIGHT_WALK2 */
{SPR_KNIG,2,4,{(actionf_p1)A_Chase},S_KNIGHT_WALK4,0,0},	/* S_KNIGHT_WALK3 */
{SPR_KNIG,3,4,{(actionf_p1)A_Chase},S_KNIGHT_WALK1,0,0},	/* S_KNIGHT_WALK4 */
{SPR_KNIG,4,10,{(actionf_p1)A_FaceTarget},S_KNIGHT_ATK2,0,0},	/* S_KNIGHT_ATK1 */
{SPR_KNIG,5,8,{(actionf_p1)A_FaceTarget},S_KNIGHT_ATK3,0,0},	/* S_KNIGHT_ATK2 */
{SPR_KNIG,6,8,{(actionf_p1)A_KnightAttack},S_KNIGHT_ATK4,0,0},	/* S_KNIGHT_ATK3 */
{SPR_KNIG,4,10,{(actionf_p1)A_FaceTarget},S_KNIGHT_ATK5,0,0},	/* S_KNIGHT_ATK4 */
{SPR_KNIG,5,8,{(actionf_p1)A_FaceTarget},S_KNIGHT_ATK6,0,0},	/* S_KNIGHT_ATK5 */
{SPR_KNIG,6,8,{(actionf_p1)A_KnightAttack},S_KNIGHT_WALK1,0,0},	/* S_KNIGHT_ATK6 */
{SPR_KNIG,7,3,{NULL},S_KNIGHT_PAIN2,0,0},	/* S_KNIGHT_PAIN1 */
{SPR_KNIG,7,3,{(actionf_p1)A_Pain},S_KNIGHT_WALK1,0,0},	/* S_KNIGHT_PAIN2 */
{SPR_KNIG,8,6,{NULL},S_KNIGHT_DIE2,0,0},	/* S_KNIGHT_DIE1 */
{SPR_KNIG,9,6,{(actionf_p1)A_Scream},S_KNIGHT_DIE3,0,0},	/* S_KNIGHT_DIE2 */
{SPR_KNIG,10,6,{NULL},S_KNIGHT_DIE4,0,0},	/* S_KNIGHT_DIE3 */
{SPR_KNIG,11,6,{(actionf_p1)A_NoBlocking},S_KNIGHT_DIE5,0,0},	/* S_KNIGHT_DIE4 */
...
{SPR_SPAX,32768,3,{(actionf_p1)A_ContMobjSound},S_SPINAXE2,0,0},	/* S_SPINAXE1 */
...
{SPR_RAXE,32768,5,{(actionf_p1)A_DripBlood},S_REDAXE2,0,0},	/* S_REDAXE1 */
{SPR_RAXE,32769,5,{(actionf_p1)A_DripBlood},S_REDAXE1,0,0},	/* S_REDAXE2 */
...
{SPR_SRCR,0,10,{(actionf_p1)A_Look},S_SRCR1_LOOK2,0,0},	/* S_SRCR1_LOOK1 */
{SPR_SRCR,1,10,{(actionf_p1)A_Look},S_SRCR1_LOOK1,0,0},	/* S_SRCR1_LOOK2 */
{SPR_SRCR,0,5,{(actionf_p1)A_Sor1Chase},S_SRCR1_WALK2,0,0},	/* S_SRCR1_WALK1 */
{SPR_SRCR,1,5,{(actionf_p1)A_Sor1Chase},S_SRCR1_WALK3,0,0},	/* S_SRCR1_WALK2 */
{SPR_SRCR,2,5,{(actionf_p1)A_Sor1Chase},S_SRCR1_WALK4,0,0},	/* S_SRCR1_WALK3 */
{SPR_SRCR,3,5,{(actionf_p1)A_Sor1Chase},S_SRCR1_WALK1,0,0},	/* S_SRCR1_WALK4 */
{SPR_SRCR,16,6,{(actionf_p1)A_Sor1Pain},S_SRCR1_WALK1,0,0},	/* S_SRCR1_PAIN1 */
{SPR_SRCR,16,7,{(actionf_p1)A_FaceTarget},S_SRCR1_ATK2,0,0},	/* S_SRCR1_ATK1 */
{SPR_SRCR,17,6,{(actionf_p1)A_FaceTarget},S_SRCR1_ATK3,0,0},	/* S_SRCR1_ATK2 */
{SPR_SRCR,18,10,{(actionf_p1)A_Srcr1Attack},S_SRCR1_WALK1,0,0},	/* S_SRCR1_ATK3 */
{SPR_SRCR,18,10,{(actionf_p1)A_FaceTarget},S_SRCR1_ATK5,0,0},	/* S_SRCR1_ATK4 */
{SPR_SRCR,16,7,{(actionf_p1)A_FaceTarget},S_SRCR1_ATK6,0,0},	/* S_SRCR1_ATK5 */
{SPR_SRCR,17,6,{(actionf_p1)A_FaceTarget},S_SRCR1_ATK7,0,0},	/* S_SRCR1_ATK6 */
{SPR_SRCR,18,10,{(actionf_p1)A_Srcr1Attack},S_SRCR1_WALK1,0,0},	/* S_SRCR1_ATK7 */
{SPR_SRCR,4,7,{NULL},S_SRCR1_DIE2,0,0},	/* S_SRCR1_DIE1 */
{SPR_SRCR,5,7,{(actionf_p1)A_Scream},S_SRCR1_DIE3,0,0},	/* S_SRCR1_DIE2 */
...
{SPR_SRCR,11,25,{(actionf_p1)A_SorZap},S_SRCR1_DIE9,0,0},	/* S_SRCR1_DIE8 */
...
{SPR_SRCR,11,20,{(actionf_p1)A_SorZap},S_SRCR1_DIE13,0,0},	/* S_SRCR1_DIE12 */
...
{SPR_SRCR,15,-1,{(actionf_p1)A_SorcererRise},S_NULL,0,0},	/* S_SRCR1_DIE17 */
...
{SPR_SOR2,2,4,{(actionf_p1)A_SorRise},S_SOR2_RISE4,0,0},	/* S_SOR2_RISE3 */
...
{SPR_SOR2,6,12,{(actionf_p1)A_SorSightSnd},S_SOR2_WALK1,0,0},	/* S_SOR2_RISE7 */
{SPR_SOR2,12,10,{(actionf_p1)A_Look},S_SOR2_LOOK2,0,0},	/* S_SOR2_LOOK1 */
{SPR_SOR2,13,10,{(actionf_p1)A_Look},S_SOR2_LOOK1,0,0},	/* S_SOR2_LOOK2 */
{SPR_SOR2,12,4,{(actionf_p1)A_Chase},S_SOR2_WALK2,0,0},	/* S_SOR2_WALK1 */
{SPR_SOR2,13,4,{(actionf_p1)A_Chase},S_SOR2_WALK3,0,0},	/* S_SOR2_WALK2 */
{SPR_SOR2,14,4,{(actionf_p1)A_Chase},S_SOR2_WALK4,0,0},	/* S_SOR2_WALK3 */
{SPR_SOR2,15,4,{(actionf_p1)A_Chase},S_SOR2_WALK1,0,0},	/* S_SOR2_WALK4 */
{SPR_SOR2,16,3,{NULL},S_SOR2_PAIN2,0,0},	/* S_SOR2_PAIN1 */
{SPR_SOR2,16,6,{(actionf_p1)A_Pain},S_SOR2_WALK1,0,0},	/* S_SOR2_PAIN2 */
{SPR_SOR2,17,9,{(actionf_p1)A_Srcr2Decide},S_SOR2_ATK2,0,0},	/* S_SOR2_ATK1 */
{SPR_SOR2,18,9,{(actionf_p1)A_FaceTarget},S_SOR2_ATK3,0,0},	/* S_SOR2_ATK2 */
{SPR_SOR2,19,20,{(actionf_p1)A_Srcr2Attack},S_SOR2_WALK1,0,0},	/* S_SOR2_ATK3 */
...
{SPR_SDTH,0,8,{(actionf_p1)A_Sor2DthInit},S_SOR2_DIE2,0,0},	/* S_SOR2_DIE1 */
{SPR_SDTH,1,8,{NULL},S_SOR2_DIE3,0,0},	/* S_SOR2_DIE2 */
{SPR_SDTH,2,8,{(actionf_p1)A_SorDSph},S_SOR2_DIE4,0,0},	/* S_SOR2_DIE3 */
{SPR_SDTH,3,7,{NULL},S_SOR2_DIE5,0,0},	/* S_SOR2_DIE4 */
{SPR_SDTH,4,7,{NULL},S_SOR2_DIE6,0,0},	/* S_SOR2_DIE5 */
{SPR_SDTH,5,7,{(actionf_p1)A_Sor2DthLoop},S_SOR2_DIE7,0,0},	/* S_SOR2_DIE6 */
{SPR_SDTH,6,6,{(actionf_p1)A_SorDExp},S_SOR2_DIE8,0,0},	/* S_SOR2_DIE7 */
{SPR_SDTH,7,6,{NULL},S_SOR2_DIE9,0,0},	/* S_SOR2_DIE8 */
{SPR_SDTH,8,18,{NULL},S_SOR2_DIE10,0,0},	/* S_SOR2_DIE9 */
{SPR_SDTH,9,6,{(actionf_p1)A_NoBlocking},S_SOR2_DIE11,0,0},	/* S_SOR2_DIE10 */
{SPR_SDTH,10,6,{(actionf_p1)A_SorDBon},S_SOR2_DIE12,0,0},	/* S_SOR2_DIE11 */
...
{SPR_SDTH,14,-1,{(actionf_p1)A_BossDeath},S_NULL,0,0},	/* S_SOR2_DIE15 */
{SPR_FX16,32768,3,{(actionf_p1)A_BlueSpark},S_SOR2FX1_2,0,0},	/* S_SOR2FX1_1 */
{SPR_FX16,32769,3,{(actionf_p1)A_BlueSpark},S_SOR2FX1_3,0,0},	/* S_SOR2FX1_2 */
{SPR_FX16,32770,3,{(actionf_p1)A_BlueSpark},S_SOR2FX1_1,0,0},	/* S_SOR2FX1_3 */
{SPR_FX16,32774,5,{(actionf_p1)A_Explode},S_SOR2FXI1_2,0,0},	/* S_SOR2FXI1_1 */
...
{SPR_FX11,32768,5,{(actionf_p1)A_GenWizard},S_SOR2FX2_3,0,0},	/* S_SOR2FX2_2 */
...
{SPR_MNTR,0,10,{(actionf_p1)A_Look},S_MNTR_LOOK2,0,0},	/* S_MNTR_LOOK1 */
{SPR_MNTR,1,10,{(actionf_p1)A_Look},S_MNTR_LOOK1,0,0},	/* S_MNTR_LOOK2 */
{SPR_MNTR,0,5,{(actionf_p1)A_Chase},S_MNTR_WALK2,0,0},	/* S_MNTR_WALK1 */
{SPR_MNTR,1,5,{(actionf_p1)A_Chase},S_MNTR_WALK3,0,0},	/* S_MNTR_WALK2 */
{SPR_MNTR,2,5,{(actionf_p1)A_Chase},S_MNTR_WALK4,0,0},	/* S_MNTR_WALK3 */
{SPR_MNTR,3,5,{(actionf_p1)A_Chase},S_MNTR_WALK1,0,0},	/* S_MNTR_WALK4 */
{SPR_MNTR,21,10,{(actionf_p1)A_FaceTarget},S_MNTR_ATK1_2,0,0},	/* S_MNTR_ATK1_1 */
{SPR_MNTR,22,7,{(actionf_p1)A_FaceTarget},S_MNTR_ATK1_3,0,0},	/* S_MNTR_ATK1_2 */
{SPR_MNTR,23,12,{(actionf_p1)A_MinotaurAtk1},S_MNTR_WALK1,0,0},	/* S_MNTR_ATK1_3 */
{SPR_MNTR,21,10,{(actionf_p1)A_MinotaurDecide},S_MNTR_ATK2_2,0,0},	/* S_MNTR_ATK2_1 */
{SPR_MNTR,24,4,{(actionf_p1)A_FaceTarget},S_MNTR_ATK2_3,0,0},	/* S_MNTR_ATK2_2 */
{SPR_MNTR,25,9,{(actionf_p1)A_MinotaurAtk2},S_MNTR_WALK1,0,0},	/* S_MNTR_ATK2_3 */
{SPR_MNTR,21,10,{(actionf_p1)A_FaceTarget},S_MNTR_ATK3_2,0,0},	/* S_MNTR_ATK3_1 */
{SPR_MNTR,22,7,{(actionf_p1)A_FaceTarget},S_MNTR_ATK3_3,0,0},	/* S_MNTR_ATK3_2 */
{SPR_MNTR,23,12,{(actionf_p1)A_MinotaurAtk3},S_MNTR_WALK1,0,0},	/* S_MNTR_ATK3_3 */
{SPR_MNTR,23,12,{NULL},S_MNTR_ATK3_1,0,0},	/* S_MNTR_ATK3_4 */
{SPR_MNTR,20,2,{(actionf_p1)A_MinotaurCharge},S_MNTR_ATK4_1,0,0},	/* S_MNTR_ATK4_1 */
{SPR_MNTR,4,3,{NULL},S_MNTR_PAIN2,0,0},	/* S_MNTR_PAIN1 */
{SPR_MNTR,4,6,{(actionf_p1)A_Pain},S_MNTR_WALK1,0,0},	/* S_MNTR_PAIN2 */
{SPR_MNTR,5,6,{NULL},S_MNTR_DIE2,0,0},	/* S_MNTR_DIE1 */
{SPR_MNTR,6,5,{NULL},S_MNTR_DIE3,0,0},	/* S_MNTR_DIE2 */
{SPR_MNTR,7,6,{(actionf_p1)A_Scream},S_MNTR_DIE4,0,0},	/* S_MNTR_DIE3 */
...
{SPR_MNTR,12,5,{(actionf_p1)A_NoBlocking},S_MNTR_DIE9,0,0},	/* S_MNTR_DIE8 */
...
{SPR_MNTR,19,-1,{(actionf_p1)A_BossDeath},S_NULL,0,0},	/* S_MNTR_DIE15 */
...
{SPR_FX13,0,2,{(actionf_p1)A_MntrFloorFire},S_MNTRFX2_1,0,0},	/* S_MNTRFX2_1 */
{SPR_FX13,32776,4,{(actionf_p1)A_Explode},S_MNTRFXI2_2,0,0},	/* S_MNTRFXI2_1 */
...
{SPR_AMG1,0,100,{(actionf_p1)A_ESound},S_SND_WIND,0,0},	/* S_SND_WIND */
  {SPR_AMG1,0,85,{(actionf_p1)A_ESound},S_SND_WATERFALL,0,0}	/* S_SND_WATERFALL */
};
...
S_NULL,		/* xdeathstate */
/* sfx_volhit,	not defined ! */	/* deathsound */
sfx_lobhit,
2*FRACUNIT,		/* speed */
8*FRACUNIT,		/* radius */
8*FRACUNIT,		/* height */
...
75,		/* mass */
0,		/* damage */
/* sfx_mumact, not defined ! */		/* activesound */
sfx_mumsit,
...
/* sfx_impact,  not defined ! */	/* activesound */
sfx_impsit,
...
150,		/* mass */
0,		/* damage */
/* sfx_kgtact, not defined ! */		/* activesound */
sfx_kgtsit,
MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,		/* flags */
MF2_FOOTCLIP|MF2_PASSMOBJ		/* flags2 */
 },
...
/* sfx_sbtsit, not defined ! */		/* seesound */
sfx_bstsit,
8,		/* reactiontime */
/* sfx_sbtatk, not defined !*/		/* attacksound */
sfx_bstatk,
