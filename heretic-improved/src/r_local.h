...
/* #define BASEYCENTER             (100-((screenheight-200)/24)) */
#define BASEYCENTER              (60+(8000/screenheight))
...
typedef struct
{
    ...
    int			minx, maxx;
    unsigned short      pad1;
    unsigned short      top[MAXSCREENWIDTH];
    unsigned short      pad2;
    unsigned short      pad3;
    unsigned short      bottom[MAXSCREENWIDTH];
    unsigned short      pad4;
} visplane_t;
...
extern	fixed_t		pspritescale, pspriteiscale, pspriteyscale;
